<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PaginaMaestro.Master" CodeFile="Personas.aspx.cs" Inherits="Web.Personas" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContentBase" runat="server">
	...
	<asp:ObjectDataSource ID="odsPersonas" runat="server" DataObjectTypeName="Business.Entities.Persona" DeleteMethod="Delete" TypeName="Business.Logic.PersonaLogic" UpdateMethod="Save" InsertMethod="Save">
