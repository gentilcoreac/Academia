<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BasePaginaMaestra.Master" CodeBehind="PersonasEditar.aspx.cs" Inherits="Web.UsuariosEditar" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContentBase">
	...
	<table class="table table-stripped" style="float:left" id="tblDatosSistema">
		<tr>
			<td colspan="2">
